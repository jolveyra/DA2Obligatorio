...
namespace ManagementApiTest
{
    ...
    public class EmployeeRequestControllerTest
    {
        ...
        public void GetAllEmployeeRequestTestOk()
        {
            ...
            {
                new Request() { Id = Guid.NewGuid(), Description = "Description 1", Flat = new Flat(), AssignedEmployee = new User() { Id = employeeId }, Category = new Category() { Id = Guid.NewGuid(), Name = "Category 1" } },
                new Request() { Id = Guid.NewGuid(), Description = "Description 2", Flat = new Flat(), AssignedEmployee = new User() { Id = Guid.NewGuid() }, Category = new Category() { Id = Guid.NewGuid(), Name = "Category 2" } }
            };
