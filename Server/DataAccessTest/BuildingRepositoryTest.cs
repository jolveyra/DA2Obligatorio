...
namespace DataAccessTest
{
    ...
    public class BuildingRepositoryTest
    {
        ...
        public void GetAllBuildingsTestOk()
        {
            ...
            {
                new Building() { Id = Guid.NewGuid(), Name = "Building 1", ConstructorCompanyId =  Guid.NewGuid(), SharedExpenses = 150 },
                new Building() {Id = Guid.NewGuid(), Name = "Building 2", ConstructorCompanyId =  Guid.NewGuid(), SharedExpenses = 152}
        ...
        {
            Building building = new Building() { Id = Guid.NewGuid(), Name = "Building 1", Address = new Address() {Street = "Street", DoorNumber = 12, CornerStreet = "Another Street", Latitude = -34.88449565, Longitude = -56.1587038155517}, ConstructorCompanyId = Guid.NewGuid(), SharedExpenses = 150 };
        ...
        {
            Building expected = new Building() { Id = Guid.NewGuid(), Name = "Building 1", ConstructorCompanyId = Guid.NewGuid(), SharedExpenses = 200 };


            mockContext.Setup(x => x.Buildings).ReturnsDbSet(new List<Building>() { new Building() { Id = expected.Id, Name = "Building 1", ConstructorCompanyId = expected.ConstructorCompanyId, SharedExpenses = 150 } });
        ...
        public void DeleteBuildingTestOk()
        {
            ...
            Building toDeleteBuilding = new Building() { Id = id, Name = "Building 1", Address = new Address() { Street = "Street", DoorNumber = 12, CornerStreet = "Another Street" }, ConstructorCompanyId = Guid.NewGuid(), SharedExpenses = 150 };
